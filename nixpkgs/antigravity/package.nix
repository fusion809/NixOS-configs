{ lib, stdenv, buildVscode, fetchurl, jq, writeShellScript, coreutils
, webkitgtk_4_1, libsoup_3, openssl_3, commandLineArgs ? ""
...
in (buildVscode {
  ...
  buildInputs = (oldAttrs.buildInputs or [ ])
    ++ [ webkitgtk_4_1 libsoup_3 openssl_3 ];
