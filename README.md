...
<br/><br/>
If the used disk space is less than 70%, it is <span style="color: #66BB6A">green</span> If it is between 70 to &lt;80%, it is <span style="color: #9CCC65">lighter green</span>. If it is between 80 to &lt;90%, it is <span style="color: #FFCA28">yellow</span>. If it is between 90 to &lt;95%, it is <span style="color: #FF7043">orange</span>. If it is &geq;95%, it is <span style="color: #EF5350">red</span>. The reason for the higher boundaries is that my /data partition was already very full when this NixOS install was setup.</li>
