...

{
  ...
  # nix-env -f '<nixos-unstable>' -iA package
     wget git gitAndTools.hub vimHugeX vlc firefox hexchat os-prober yakuake konversation libsForQt5.kglobalaccel ffmpegthumbnailer psmisc efibootmgr gnome3.gnome-tweaks chrome-gnome-shell gimp gnome3.zenity octave imagemagick gnome3.gnome-mines gnome3.aisleriot atom vscode notepadqq neovim scilab-bin google-chrome googleearth xclip font-awesome_5 kdevelop gnumake gcc
  ];
